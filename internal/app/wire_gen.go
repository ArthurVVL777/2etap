...
func InitApp(name string, creds postgres.Creds, metrics bool, rc redis.Creds) (*App, error) {
	...
	legalentitiesRepository := legalentities.NewRepository(gdb, rds)
	legalentitiesService := legalentities.NewService(legalentitiesRepository, dictionaryService, catalogsService)
